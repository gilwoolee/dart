...
{
public:
  TrackEETask(dart::dynamics::Skeleton* _model,
              dart::dynamics::Skeleton* _obj,
              int _eeIndex,
              char* _name,
              tasks::EETraj* _traj = NULL);
  ...
  dart::dynamics::Skeleton* getObj() const { return mObj; }
  void setObj(dart::dynamics::Skeleton* _obj) { mObj = _obj; }
