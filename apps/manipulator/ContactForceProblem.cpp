...
namespace optimizer {
	ContactForceProblem::ContactForceProblem(std::vector<Eigen::Vector3d>& _contactPoints, std::vector<Eigen::Vector3d>& _normals, Eigen::Vector3d _totalForce, Eigen::Vector3d _totalTorque, Eigen::Vector3d _objCOM)
		: Problem() {
